...
1.1. Документация должна быть оформленна в виде страниц .md

1.2. Документация должна содержать инструкцию по применению

1.3. Документация должна содержать описание контрольных примеров

1.4. Документация к библиотеке должна быть доступна с landing page
...
3.1. Интеграция должна быть выполнена с использованием open-sourse продуктами
...
4.3. Убедиться в правильности работы систем в соответствии с зачами
